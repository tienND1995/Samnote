...
const UserSetting = () => {
 ...
 //   defaultValues: async () => {
 //    const res = await axios.get(`https://samnote.mangasocial.online/profile/70`)
 //    const { Avarta, name, gmail } = res.data.user
 //    const dataHookForm = {
 //     avatar: Avarta,
 //     name,
 //     email: gmail,
 ...
 //     <div className='flex bg-blue-300 items-center gap-5'>
 //      <label htmlFor=''>Avatar</label>

 //      {errors?.avatar && !avatar1 && (
 //       <span className='text-red-400 mt-3'>{errors.avatar.message}</span>
 //      )}

 //      <div className='flex items-center gap-3'>
 //       <img
 //        className='size-[50px] object-cover rounded-full'
 //        src={avatar1 || avatarDefault}
 //        alt='avatar default'
 //       />
 ...
 //         className='bg-gray-400 cursor-pointer py-2 px-3 rounded-lg'
 //        >
 //         change
 //        </label>
 //       </div>
