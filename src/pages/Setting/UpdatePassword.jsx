 ...
 return (
  <>
    ...
    *What is Password 2 used for? If you have sensitive information such
    asprivate photos, lover is contacts... you want to secure it so that
    anyoneholding your phone cannot see it?, Password 2 was born to provide
    2-layersecurity, for example, your wife holds your phone but they also
    cannot access your secure notes information.
   </p>
   <Box className='flex mt-[20px] flex-col sm:flex-row'>
    <Typography className='w-[300px] mb-[10px] sm:mb-0'>Password 2:</Typography>
