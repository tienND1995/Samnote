...
const UserIntro = ({ userInfomations, user, userID }) => {
    ...
    console.log(userID, user.id, typeof userID, typeof user.id)
    ...
    return (
        <div className='intro-user w-full h-auto'>
            <div className='cover-photo-container relative'>
                ...
                />
                <Box className="position-absolute flex justify-end w-full px-5"
                    style={{
                        top: '25%', left: '0',
                    }}>
            ...
            <div className='info-user-container flex items-center justify-between 
                ...
                <div className='info-user flex items-center gap-8 lg:w-auto sm:w-full'>
                    ...
                    <Box className='text-white'>
                        <Typography
                            variant='h4'
                            className='name-user font-bold mb-1'
                        >
