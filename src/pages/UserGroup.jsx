...
//         `https://samnote.mangasocial.online/group/create/${user.id}`,
//         groupData
//       );

//       // Log thông điệp từ phản hồi ra console
...
//                       borderRadius: "30px",
//                       "&:hover": {
//                         backgroundColor: " rgba(178, 178, 178, 0.3)", // Change to desired hover color
//                         cursor: "pointer",
//                       },
//                     }}
...
const UserGroup = () => {
  ...
  useEffect(() => {
    const newSocket = io("https://samnote.mangasocial.online/send_message/66");
    setSocket(newSocket);
  ...
  useEffect(() => {
    if (socket) {
      ...
      socket.on("receive_message", (message) => {
        ...
        // Ví dụ: cập nhật giao diện, hiển thị tin nhắn mới
      });

      return () => {
        // Ngắt kết nối khi component bị xoá
