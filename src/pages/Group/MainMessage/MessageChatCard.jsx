...
const MessageChatCard = ({ message, userID, onDeleteMessage, avatar }) => {
 console.log('message', message.idSend === userID)
 return message.idSend === userID ? (
  <div className='h-auto flex flex-col messages-end'>
   <div className='flex gap-2 mb-1'>
    <div className='flex messages-center hover-message gap-1'>
     <button
      style={{
       border: 'none',
     ...
     <div className='flex flex-col gap-1 messages-end'>
      {message.image && (
       <div>
        <img
  ...
  <div className='h-auto mb-2'>
   <div className='flex gap-2 mb-1'>
    <div className='flex gap-1 messages-end'>
     <img
